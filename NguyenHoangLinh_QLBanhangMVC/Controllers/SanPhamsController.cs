...
namespace NguyenHoangLinh_QLBanhangMVC.Controllers
{
    public class SanPhamsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaSanPham,TenSanPham,GiaTien,MoTa,LaSanPhamMoi,HinhAnh,SoLuong,MaDanhMuc")] SanPham sanPham)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaSanPham,TenSanPham,GiaTien,MoTa,LaSanPhamMoi,HinhAnh,SoLuong,MaDanhMuc")] SanPham sanPham)
        {
            if (ModelState.IsValid)
            {
